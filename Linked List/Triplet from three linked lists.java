		...
		public void triple(LinkedList l1, LinkedList l2, LinkedList l3, int target) throws Exception {
			...
			while(curr1!=null){
				...
				while(curr2!=null && curr3!=null){
					if(curr1.data + curr2.data + curr3.data == target){
						System.out.print(curr1.data+" "+curr2.data+" "+curr3.data);
						return;
					}
					else if(curr1.data + curr2.data + curr3.data > target){
						curr2=curr2.next;
					}
					else{
						curr3=curr3.next;
